...
/*
Codigo equivalente con JS sin usar JQuery
...
class MyNotes {
  ...
  makeNoteEditable(thisNote) {
    ...
    thisNote.data("state", "editable"); // Añadimos este codigo para poder discernir cuando es editable y cuando no 
  }
  makeNoteReadOnly(thisNote) {
  ...
  createNote() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      data: ourNewPost,
      success: response => {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(".new-note-title, .new-note-body").val(""); // reinicar los valores
      ...
      error: response => {
        if (response.responseText == "You have reached your note limit") {
          // Veremos desde el inspector de la consola donde esta el mensaje
...
class Search {
  ...
  keyPressDispatcher(e) {
    ...
    if (e.keyCode == 220 && !this.isOverlayopen && jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) {
      this.openOverlay();
    }
